...
GPS_Data_t     robot_gps           = {0.0f, 0.0f, 0};
Encoder_Data_t robot_encoder_left  = {0, 0.0f};
Encoder_Data_t robot_encoder_right = {0, 0.0f};

void Telemetry_Init(TIM_HandleTypeDef *htim_left, TIM_HandleTypeDef *htim_right)
{
...
void Telemetry_Update_Encoders(TIM_HandleTypeDef *htim_left, TIM_HandleTypeDef *htim_right)
{

 ...
 *   uint16  checksum     (XOR: mode_request'ten e_stop'a kadar)
 * -------------------------------------------------------------------------*/
...
/**
 * @brief UART alım tamponunu tara, geçerli komutu uygula.
 * @param buf  HAL DMA/IT alım tamponu
 * @param len  Tampondaki geçerli byte sayısı
 */
...
/** @return true → e-stop yok VE IMU güvenli */

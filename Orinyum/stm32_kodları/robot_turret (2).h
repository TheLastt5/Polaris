...
#define TURRET_LOCK_THRESH  3.0f    /* px  – kilit pixel eşiği             */
#define TURRET_LOCK_TIME_MS 1000U   /* ms  – kilitli kalma süresi          */
#define TURRET_PWM_LIMIT    800U    /* ARR birimine göre maks. PWM değeri  */
...
typedef enum {
    ...
    TURRET_TRACKING,       /* Hedef görüldü, kilitlenme bekleniyor        */
    TURRET_LOCKED,         /* Kilitlenme süresi doldu, ateş geçişi        */
    TURRET_FIRING          /* Lazer aktif, hedef takip devam              */
} TurretState_t;
...
/**
 * @brief Acil durdurma: tüm servo ve lazer PWM'lerini sıfırlar.
 */
